  ...
  useEffect(() => {
    api.get<any>("/config/").then((res) => {
      if (res.success && res.data) {
        setContent(res.data.terms || res.data.terms_of_service || "Terms of service have not been set yet.");
      } else {
  ...
  return (
    <div className="min-h-screen bg-background py-16 px-4">
      <div className="max-w-3xl mx-auto bg-surface border border-border rounded-xl p-8 md:p-12">
        <h1 className="text-3xl font-display font-bold mb-8 text-center">Terms of Service</h1>
